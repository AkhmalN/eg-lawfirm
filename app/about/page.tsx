              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                  <p>
                    ...
                    kebutuhan klien perorangan maupun korporasi dengan
                    pendekatan hukum yang modern, solutif, dan berorientasi pada
                    hasil.
                  </p>
                  <p>
                    ...
                    hukum yang kami ambil mampu memberikan perlindungan dan
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                  ...
                  <p>
                    Sebagai pendiri EG Law Firm, beliau memiliki pengalaman
                    dalam menangani berbagai perkara hukum baik litigasi maupun
                    non-litigasi. Dedikasi terhadap keadilan, kemampuan
                    negosiasi yang kuat, serta pemahaman mendalam mengenai hukum
                    di Indonesia menjadikan EG Law Firm partner terpercaya bagi
                    setiap klien.
                  </p>
                  <p>
                    Dengan rekam jejak dalam mewakili klien dari berbagai
                    sektor, beliau selalu mengedepankan analisis yang tajam,
                    strategi yang tepat, serta penyelesaian yang berfokus pada
